...
def filename_get(file_path):

    global filename
    filename = file_path
filename_get(r"C:\Users\白山\Desktop\Python\参赛作评\forya.wav")

def rnd_color():
    h, s, l = random.random(), 0.5 + random.random() / 2.0, 0.4 + random.random() / 5.0
    return [int(120 * i) for i in colorsys.hls_to_rgb(h, l, s)]
